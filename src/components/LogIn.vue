<template>
  ...
  >
    <header class="flex flex-col items-center">
      <h1 class="text-white sm:mt-10 sm:text-3xl mb-2">Log in to your account</h1>
      <span class="text-mediumGray text-sm mb-2">Welcome back! Please enter your details.</span>
    </header>
    <Form
    ...
    >
      ...
      <span class="text-sm sm:text-[16px] text-center text-mediumGray"
        >Don't have an account? <button class="text-mediumBlue underline">Sign Up</button></span
      >
    </Form>
  </div>
</template>
